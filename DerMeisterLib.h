...
//{------------------------------------------------------------------------------------------------------
//! Рисует лесополосу для функции Background
//!
//! @param x        x-координата объекта
//! @param time     Время, от которого зависит x-координата объекта
//!
//! @par            Пример использования:
//!
//! @see            Background ()
...
//{------------------------------------------------------------------------------------------------------
//! Рисует лесополосу для функции BackgroundSize
//!
//! @param x        x-координата объекта
//! @param time     Время, от которого зависит x-координата объекта
//!
...
//!
//! @note           Начальной точкой является начало заднего крыла
//!
//! @par            Пример использования:
//!
...
//! @param time     Параметр времени, от которого зависит наличие ветра
//!
//! @par            Пример использования:
//!
//! @see            BackgroundMore ()
...
//{------------------------------------------------------------------------------------------------------
//! Рисует замечательного мужчину сзади
//!
...
//! @note               Начальной точкой является центр головы
//!
//! @par                Пример использования:
//!
...
//{------------------------------------------------------------------------------------------------------
//! Рисует рыбака на лодке
//!
//! @param x            x-координата расположения котика
//! @param y            y-координата расположения котика
//! @param Udochka      Забрасывание удочки рыбаком. 0 - размах удочки, 1 - забрасывание
//! @param Size         Размер котика
//!
//! @note               Начальной точкой является центр туловища рыбака
//!
//! @par                Пример использования:
//!
...
//{------------------------------------------------------------------------------------------------------
//! Рисует замечательного мужчину в профиль
//!
//! @param x            x-координата расположения мистера
//! @param y            y-координата расположения мистера
...
//{------------------------------------------------------------------------------------------------------
//! Рисует замечательного рыжего котика сзади))
//!
//! @param x            x-координата расположения котика
//! @param y            y-координата расположения котика
//! @param Size         Размер котика
//! @param Us1          Положение верхних усов. 0 - начальное положение, 1 - поднимаются вверх
//! @param Us2          Положение средних усов. 0 - начальное положение, 1 - поднимаются вверх
//! @param Us3          Положение нижних усов. 0 - начальное положение, 1 - поднимаются вверх
//! @param Hvost        Котик машет хвостом влево. 0 - начальное положение, 1 - влево
//!
//! @note               Начальной точкой является левый угол головы
//!
//! @par                Пример использования:
//!
...
//{------------------------------------------------------------------------------------------------------
//! Рисует прекрасную мадмуазель сзади
//!
...
//!
//! @note               Начальной точкой является начало переднего крыла
//!
//! @par                Пример использования:
//!
...
//{------------------------------------------------------------------------------------------------------
//! Рисует замечательного рыжего котика))
//!
//! @param x            x-координата расположения котика
//! @param y            y-координата расположения котика
//! @param Size         Размер котика
...
//! @param Us2          Положение средних усов. 0 - начальное положение, 1 - поднимаются вверх
//! @param Us3          Положение нижних усов. 0 - начальное положение, 1 - поднимаются вверх
//! @param Hvost        Котик машет хвостом влево/вправо. 0 - влево, 1 - вправо
//! @param Lapki        Лапки котика идут)) 0 - шаг левыми лапками, 1 - правыми
//! @param Stop         Лапки котика перестают двигаться и принимают положение стоя
//!
//! @note               Начальной точкой является левый угол головы
//!
//! @par                Пример использования:
...
//{------------------------------------------------------------------------------------------------------
//! Рисует замечательного мужчину
//!
//! @param x            x-координата расположения мистера
//! @param y            y-координата расположения мистера
//! @param Glaza        Размер глаз. Служит для передачи глубокого удивления, за счёт увеличения радиуса
//! @param Zrachki      Размер зрачков. Служит для того же, что и параметр "Glaza"
//! @param Rot          Позволяет открыть и закрыть рот мужчине, за счёт увеличения ширины эллипса))
//! @param UpRukaL      Поднимает левую руку. 0 - опущенное положение, 1 - поднятое
//! @param UpRukaP      Поднимает правую руку. 0 - опущенное положение, 1 - поднятое
//! @param Size         Размер изображения мистера
//!
...
//!
//! @note               Начальной точкой является левая нижняя точка кузова
//!
//! @par                Пример использования:
//!
...
//! @param UpNogaP      Поднимает правую ногу. 0 - опущенное положение, 1 - поднятое
//! @param Size         Размер мадмуазель
//! @param Otragenie    Отражает изображение по горизонтали.
//!                     0 - мадмуазель направлена в левую сторону, 1 - в правую
//!
//! @note               Начальной точкой является центр головы
//!
//! @par                Пример использования:
...
//! @param Glaza        Размер глаз. Служит для передачи глубокого удивления, за счёт увеличения радиуса
//! @param Zrachki      Размер зрачков. Служит для того же, что и параметр "Glaza"
//! @param Rot          Позволяет открыть и закрыть рот даме, за счёт увеличения ширины эллипса))
//! @param UpRukaL      Поднимает левую руку. 0 - опущенное положение, 1 - поднятое
//! @param UpRukaP      Поднимает правую руку. 0 - опущенное положение, 1 - поднятое
//! @param UpNogaL      Поднимает левую ногу. 0 - опущенное положение, 1 - поднятое
//! @param UpNogaP      Поднимает правую ногу. 0 - опущенное положение, 1 - поднятое
